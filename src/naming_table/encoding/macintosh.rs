...
#[rustfmt::skip]
const LANGUAGE_CROATIAN: [char; 128] = [
    'Ä', 'Å', 'Ç', 'É', 'Ñ', 'Ö', 'Ü', 'á', 'à', 'â', 'ä', 'ã', 'å',
    'ç', 'é', 'è', 'ê', 'ë', 'í', 'ì', 'î', 'ï', 'ñ', 'ó', 'ò', 'ô',
    'ö', 'õ', 'ú', 'ù', 'û', 'ü', '†', '°', '¢', '£', '§', '•', '¶',
    'ß', '®', 'Š', '™', '´', '¨', '≠', 'Ž', 'Ø', '∞', '±', '≤', '≥',
...
#[rustfmt::skip]
const LANGUAGE_INUKTITUT: [char; 128] = [
...
#[rustfmt::skip]
const LANGUAGE_IRISH_GAELIC: [char; 128] = [
    'Ä', 'Å', 'Ç', 'É', 'Ñ', 'Ö', 'Ü', 'á', 'à', 'â', 'ä', 'ã', 'å',
    'ç', 'é', 'è', 'ê', 'ë', 'í', 'ì', 'î', 'ï', 'ñ', 'ó', 'ò', 'ô',
    'ö', 'õ', 'ú', 'ù', 'û', 'ü', '†', '°', '¢', '£', '§', '•', '¶',
    'ß', '®', '©', '™', '´', '¨', '≠', 'Æ', 'Ø', 'Ḃ', '±', '≤', '≥',
...
pub fn decode(bytes: &[u8], encoding_id: u16, language_id: u16) -> Option<String> {
    let table = match (encoding_id, language_id) {
        ...
        (_, 18) => &LANGUAGE_CROATIAN, // Croatian
        ...
        // 141 => Afrikaans
        // 142 => Breton
        (_, 143) => &LANGUAGE_INUKTITUT, // Inuktitut
        // 144 => Scottish Gaelic
        // 145 => Manx Gaelic
        (_, 146) => &LANGUAGE_IRISH_GAELIC, // Irish Gaelic (with dot above)
        // 147 => Tongan
        // 148 => Greek (polytonic)
        // 149 => Greenlandic
